...
CREATE INDEX IF NOT EXISTS "checkout_quotes_user_active_idx"
  ON "checkout_quotes" ("userId", "createdAt" DESC) WHERE "status" = 'ACTIVE';

-- Reveal endpoint and delivery both look up results by item.
CREATE INDEX IF NOT EXISTS "order_results_item_delivered_idx"
...
CREATE INDEX IF NOT EXISTS "login_attempts_failed_recent_idx"
